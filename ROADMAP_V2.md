...
|:-:|--------|:--------:|:-------:|:------:|
| 0.1 | **zxcvbn Password Strength في Rust** — تنفيذ حقيقي بدل الـ stub | 🔴 P0 | — | ✅ مكتملة |
| 0.2 | **BIP39 Recovery Key في Rust** — تنفيذ generate/validate/seed | 🔴 P0 | — | ✅ مكتملة |
| 0.3 | **وصل Face Enrollment بالكاميرا الحقيقية** — استبدال fake delay | 🔴 P0 | — | ✅ مكتملة |
| 0.4 | **تفعيل Face Auth عند فتح التطبيق** — مطابقة embeddings | 🔴 P0 | 0.3 | ✅ مكتملة |
| 0.5 | **إصلاح 91 تحذير Lint** — deprecated APIs | 🔴 P0 | — | ✅ مكتملة |
| 0.6 | **تنظيف TODO comments المنتهية** — توحيد التعليقات | 🔴 P0 | — | ✅ مكتملة |
